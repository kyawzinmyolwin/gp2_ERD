-- COMP639 Project 2 - Required Epic Database Creation Script
-- Generated from Sprint 1 Required Epic ERD
-- Database: PostgreSQL
...
CREATE TABLE role (
    ...
    CONSTRAINT chk_role_name
        CHECK (name IN ('Super Admin', 'Member'))
);
...
CREATE TABLE group_membership (
    ...
    CONSTRAINT chk_group_membership_role
        CHECK (group_role IN ('Observer', 'Operator', 'Coordinator')),
